...
-1 ColdChipseq/raw_data/"$sample"bis/"$sample"_*_1.fq.gz -2 ColdChipseq/raw_data/"$sample"bis/"$sample"_*_2.fq.gz \
-S ColdChIP_new/results/align/"$sample"bis_nonfiltered_NoUnal.sam \
2> ColdChIP_new/results/align/"$sample"bis.log
