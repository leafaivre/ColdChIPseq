...
#SBATCH --time=04:00:00                         # replace with value for your job
...
bowtie2 -p 12 --local  -x ColdChipseq/reference/TAIR10/TAIR10 \
-1 ColdChipseq/raw_data/"$sample"/"$sample"_*_1.fq.gz -2 ColdChipseq/raw_data/"$sample"/"$sample"_*_2.fq.gz \
-S ColdChIP_new/results/align/"$sample"_nonfiltered.sam
